...
import com.bigDragon.controller.springAOP.springAOPOverview;
import com.bigDragon.controller.springIOC.SpringBean;
import com.bigDragon.controller.springIOC.ApplicationContextTest;
import com.bigDragon.controller.springIOC.AutowireTest;
import com.bigDragon.controller.springIOC.BeanFactoryTest;
import com.bigDragon.controller.springIOC.IoCTest;
import com.bigDragon.controller.springIOC.SpringLoading;
...
public class Main {
    public static void main(String[] args){
        ...
        IoCTest.main(args);
        //Servlet学习整理
        com.bigDragon.controller.servletTest.Main.main(args);
        //spring Ioc自动装配
        new AutowireTest();
        //bean的作用域
        new SpringBean();
